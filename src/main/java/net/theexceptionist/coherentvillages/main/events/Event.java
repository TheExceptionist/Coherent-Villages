...
public abstract class Event {
	...
	public static final EventImmigration small_immgrate = new EventImmigration("Immigration Small", true, 25, 5, 20, Main.SMALL_IMMIGRATE_RATE);
	public static final EventImmigration medium_immgrate = new EventImmigration("Immigration Medium", true, 30, 10, 30, Main.MEDIUM_IMMIGRATE_RATE);
	public static final EventImmigration large_immgrate = new EventImmigration("Immigration Large", true, 35, 1, 40, Main.LARGE_IMMIGRATE_RATE);
