...
public class NameGenerator {
	...
	public static String generateRandomName(Random rand, AttributeRace race) {
		...
		switch(race.getType())
		{
			...
			case AttributeRace.RACE_TYPE_BARBARIAN:
			{
				return lLatinNames[rand.nextInt(lNordNames.length)].trim();
			}
			case AttributeRace.RACE_TYPE_HIGH_BARBARIAN:
			{
				return lLatinNames[rand.nextInt(lSlavNames.length)].trim();
			}
			case AttributeRace.RACE_TYPE_FEUDAL:
			{
				return lLatinNames[rand.nextInt(lGermanNames.length)].trim();
			}
			case AttributeRace.RACE_TYPE_SAND_EMPIRE:
			{
				return lLatinNames[rand.nextInt(lArabNames.length)].trim();
			}
			default:
			{
				return "";
