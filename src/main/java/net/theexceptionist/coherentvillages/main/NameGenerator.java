...
public class NameGenerator {
	...
	private static String[] mLatinNames = 
	{
			"Manius ",
			"Caecina",
			"Sarrius",
	...
	private static String[] fLatinNames = 
	{
			"Alcelvia ",
			"Longissaeia",
			"Alessala ",
	...
	private static String[] mNordNames = 
	{
			"Asmund",
			"Audun",
			"Balder",
	...
	private static String[] fNordNames = 
	{
			"Jennie", "Udbjorg "," Ulvhild "," Unn "," Unnfrid "," Unnhild "," Unni  "," Unnlaug "," Unnveig "," Urda ",
			"Valbjorg "," Valfrid "," Valgerd  "," Varunn "," Vebjorg "," Velaug "," Venhild "," Vidrun "," Vigdis "," Vighild "," Vilbjorg "," Vilborg "," Vilfrid "," Vilgerd "," Vilgunn",
			"Ymbjorg "," Yngvild ", "Finngerd "," Finnlaug "," Fredbjorg "," Fredgunn "," Fredhild "," Fredlaug "," Fredmoy "," Freidun "," Freydis "," Frida  "," Fridbjorg "," Fridgunn "," Fridhild ",
			...
			"Hallbjorg "," Hallfrid "," Hallgerd "," Hallgunn "," Hallrid "," Hallveig "," Heidrun "," Helga "," Helgunn "," Hella "," Herbjorg "," Herborg "," Herfrid "," Hergunn "," Hervor "," Hild "," Hilde  "," Hildebjorg "," Hildeborg "," Hildegunn "," Hill "," Hjartrud "," Hjordis  "," Holmfrid  "," Hladgerd ",
			...
			"Ladgunn "," Lagertha "," Lidveig "," Lidvor "," Liv "," Liveig "," Livunn  "," Lydveig "," Lydvor",
			...
			"Thora  "," Thorbjorg "," Thorborg "," Thordis "," Thordny "," Thordun "," Thorfrid "," Torgerd "," Thorgunn "," Torgerd "," Thorunn  "," Thorvalda "," Thurid "," Tjodhild "," Tjodunn "," Tjodvor "," Tova  "," Tove ",	
	...
	private static String[] lNordNames =
	{
			"Aaberg",
			"Aland",
			"Alf",
	...
	private static String[] mGermanNames = 
	{
			"Adalbert",
			"Bernard",
			"Bero",
	...
	private static String[] fGermanNames = 
	{
			"Adaltrude",
			"Adallinda",
			"Bertrada",
	...
	private static String[] fSlavNames = 
	{
		"Agata",
		"Alicja",
		"Andzelika",
	...
	private static String[] lSlavNames =
	{
			"Andreychuk",
			"Babić, Babics",
			"Bakal, Bakal-",
	...
	private static String[] mArabNames = 
	{
			"Abbad",
			"Abbas ",
			"Abd al-Uzza",
	...
	private static String[] fArabNames = 
	{
			"Abeer",
			"Abiha",
			"Adela ",
	...
	private static String[] mGreekNames = 
	{
			"George ",
			"Panagakos",
			"Andreas ",
	...
	private static String[] fGreekNames = 
	{
			"Callidora ",
			"Pagoni",
			"Aretha ",
	...
	private static String[] lGreekNames =
	{
			"Agne",
			"Agnes",
			"Agnes",
	...
	private static String[] mFrankNames = 
	{
		"Rice",
		"Jeaneh",
		"Gauci",
	...
	private static String[] fFrankNames = 
	{
		"Aaliz",
		"Aceline",
		"Achillande",
	...
	private static String[] lFrankNames =
	{
			"Abbe",
			"Acord",
			"Acy",
	...
	private static String[] mBritonNames = 
	{
		"Drewalt",
		"Homart",
		"Gauwill",
	...
	private static String[] fBritonNames = 
	{
		"Agnes	",
		"Alice	",
		"Avice	",
	...
	private static String[] lBritonNames =
	{
			"Smith",
			"Jones",
			"Williams",
	...
	public static String generateRandomName(Random rand, AttributeRace race, int gender)
	{
		if(race == null) return "";
		switch(race.getType())
		{
			case AttributeRace.RACE_TYPE_LATIN:
			{
				...
				{
					return mLatinNames[rand.nextInt(mLatinNames.length)].trim();
				}
				else
				{
					return fLatinNames[rand.nextInt(fLatinNames.length)].trim();
				}
			}
			case AttributeRace.RACE_TYPE_NORD:
			{
				if(gender == EntityHumanVillager.GENDER_MALE)
				{
					return mNordNames[rand.nextInt(mNordNames.length)].trim();
				}
				else
				{
					return fNordNames[rand.nextInt(fNordNames.length)].trim();
				}
			}
			...
			case AttributeRace.RACE_TYPE_SLAV:
			{
				if(gender == EntityHumanVillager.GENDER_MALE)
				{
					return mSlavNames[rand.nextInt(mSlavNames.length)].trim();
				}
				else
				{
					return fSlavNames[rand.nextInt(fSlavNames.length)].trim();
				}
			}
			case AttributeRace.RACE_TYPE_ARAB:
			{
				if(gender == EntityHumanVillager.GENDER_MALE)
				{
					return mArabNames[rand.nextInt(mArabNames.length)].trim();
				}
				else
				{
					return fArabNames[rand.nextInt(fArabNames.length)].trim();
				}
			}
			case AttributeRace.RACE_TYPE_GREEK:
			{
				if(gender == EntityHumanVillager.GENDER_MALE)
				{
					return mGreekNames[rand.nextInt(mGreekNames.length)].trim();
				}
				else
				{
					return fGreekNames[rand.nextInt(fGreekNames.length)].trim();
				}
			}
			case AttributeRace.RACE_TYPE_FRANK:
			{
				if(gender == EntityHumanVillager.GENDER_MALE)
				{
					return mFrankNames[rand.nextInt(mFrankNames.length)].trim();
				}
				else
				{
					return fFrankNames[rand.nextInt(fFrankNames.length)].trim();
				}
			}
			case AttributeRace.RACE_TYPE_BRITON:
			{
				if(gender == EntityHumanVillager.GENDER_MALE)
				{
					return mBritonNames[rand.nextInt(mBritonNames.length)].trim();
				}
				else
				{
	...
	public static String generateRandomName(Random rand, AttributeRace race) {
		...
		switch(race.getType())
		{
			case AttributeRace.RACE_TYPE_LATIN:
			{
				return lLatinNames[rand.nextInt(lLatinNames.length)].trim();
			}
			case AttributeRace.RACE_TYPE_NORD:
			{
				return lNordNames[rand.nextInt(lNordNames.length)].trim();
			}
			case AttributeRace.RACE_TYPE_SLAV:
			{
				return lSlavNames[rand.nextInt(lSlavNames.length)].trim();
			}
			case AttributeRace.RACE_TYPE_GERMAN:
			{
			...
			case AttributeRace.RACE_TYPE_ARAB:
			{
				return lArabNames[rand.nextInt(lArabNames.length)].trim();
			}
			case AttributeRace.RACE_TYPE_GREEK:
			{
				return lGreekNames[rand.nextInt(lGreekNames.length)].trim();
			}
			case AttributeRace.RACE_TYPE_FRANK:
			{
				return lFrankNames[rand.nextInt(lFrankNames.length)].trim();
			}
			case AttributeRace.RACE_TYPE_BRITON:
			{
