...
public class RenderVillagerSergeant extends RenderVillagerSoldier{
	private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/captain_a.png");
	/*
	...
	*/
    ...
    public RenderVillagerSergeant(RenderManager renderManagerIn)
    {
