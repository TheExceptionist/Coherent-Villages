...
import net.theexceptionist.coherentvillages.entity.soldier.RenderVillagerSoldier;
import net.theexceptionist.coherentvillages.main.Resources;

public class RenderVillagerBanditAlchemist extends RenderVillagerSoldier{
	private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/bandit_l.png");
	/*
	...
	*/
    ...
    public RenderVillagerBanditAlchemist(RenderManager renderManagerIn)
    {
