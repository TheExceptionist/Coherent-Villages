...
public class RenderVillagerBanditArcher extends RenderVillagerSoldier{
	private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/bandit_a.png");
	/*
	...
	*/
    ...
    public RenderVillagerBanditArcher(RenderManager renderManagerIn)
    {
