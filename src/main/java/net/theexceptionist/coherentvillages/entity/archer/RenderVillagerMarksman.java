...
import net.theexceptionist.coherentvillages.main.Resources;
	...
	public class RenderVillagerMarksman  extends  RenderLiving<EntityVillager>
	{
		private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/archer_b.png");
		
		public RenderVillagerMarksman(RenderManager renderManagerIn)
	    {
