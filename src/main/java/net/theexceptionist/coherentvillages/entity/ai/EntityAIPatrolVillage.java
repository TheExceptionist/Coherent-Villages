...
public class EntityAIPatrolVillage extends EntityAIBase {
	    ...
	    public EntityAIPatrolVillage(EntityCreature entityIn, double movementSpeedIn, boolean isNocturnalIn)
	    {
	    ...
	    public boolean shouldExecute()
	    {
	        ...
	        else
	        {
	            ...
	            {
	                this.doorInfo = village.getVillageDoorInfoList().get(this.entity.world.rand.nextInt(village.getVillageDoorInfoList().size()));
	                
	               // this.doorList.get(this.entity.world.rand.nextInt(this.doorList.size()));
