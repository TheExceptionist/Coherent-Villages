...
import net.theexceptionist.coherentvillages.worldgen.villages.arrays.GreekBuildingsArray;
import net.theexceptionist.coherentvillages.worldgen.villages.chartypes.CharBlockTypes;

public class GreekStructurePieces
{
    public static void registerVillagePieces()
    {
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.ArcherHut.class, "ViBH");//**
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.Field1.class, "ViDF");//**
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.Field2.class, "ViF");//**
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.Torch.class, "ViL");//**
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.Banner.class, "ViB");
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.GuardHouse.class, "ViGH");//**
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.Shrine.class, "ViSH");//
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.SmallHut.class, "ViSmH");//**
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.ConsulHouse.class, "ViST");//**
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.BathHouse.class, "ViS");//**
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.Start.class, "ViStart");//**
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.Path.class, "ViSR");//**
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.TallHouse.class, "ViLH");//**
        MapGenStructureIO.registerStructureComponent(GreekStructurePieces.Well.class, "ViW");//**
    }

    public static List<GreekStructurePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size)
    {
        List<GreekStructurePieces.PieceWeight> list = Lists.<GreekStructurePieces.PieceWeight>newArrayList();
        list.add(new GreekStructurePieces.PieceWeight(GreekStructurePieces.Shrine.class, 4, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new GreekStructurePieces.PieceWeight(GreekStructurePieces.ConsulHouse.class, 20, MathHelper.getInt(random, 0 + size, 1 + size)));
        list.add(new GreekStructurePieces.PieceWeight(GreekStructurePieces.ArcherHut.class, 20, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new GreekStructurePieces.PieceWeight(GreekStructurePieces.SmallHut.class, 3, MathHelper.getInt(random, 2 + size, 5 + size * 3)));
        list.add(new GreekStructurePieces.PieceWeight(GreekStructurePieces.TallHouse.class, 15, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new GreekStructurePieces.PieceWeight(GreekStructurePieces.Field1.class, 3, MathHelper.getInt(random, 1 + size, 4 + size)));
        list.add(new GreekStructurePieces.PieceWeight(GreekStructurePieces.Field2.class, 3, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new GreekStructurePieces.PieceWeight(GreekStructurePieces.BathHouse.class, 15, MathHelper.getInt(random, 0, 1 + size)));
        list.add(new GreekStructurePieces.PieceWeight(GreekStructurePieces.GuardHouse.class, 8, MathHelper.getInt(random, 0 + size, 3 + size * 2)));
        Iterator<GreekStructurePieces.PieceWeight> iterator = list.iterator();
    ...
    private static int updatePieceWeight(List<GreekStructurePieces.PieceWeight> p_75079_0_)
    {
        boolean flag = false;
        int i = 0;

        for (GreekStructurePieces.PieceWeight NordStructurePieces$pieceweight : p_75079_0_)
        {
    ...
    private static GreekStructurePieces.Village findAndCreateComponentFactory(GreekStructurePieces.Start start, GreekStructurePieces.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        Class <? extends GreekStructurePieces.Village > oclass = weight.villagePieceClass;
        GreekStructurePieces.Village NordStructurePieces$village = null;

        if (oclass == GreekStructurePieces.Shrine.class)
        {
            NordStructurePieces$village = GreekStructurePieces.Shrine.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GreekStructurePieces.ConsulHouse.class)
        {
            NordStructurePieces$village = GreekStructurePieces.ConsulHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GreekStructurePieces.ArcherHut.class)
        {
            NordStructurePieces$village = GreekStructurePieces.ArcherHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GreekStructurePieces.SmallHut.class)
        {
            NordStructurePieces$village = GreekStructurePieces.SmallHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GreekStructurePieces.GuardHouse.class)
        {
            NordStructurePieces$village = GreekStructurePieces.GuardHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GreekStructurePieces.Field1.class)
        {
            NordStructurePieces$village = GreekStructurePieces.Field1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GreekStructurePieces.Field2.class)
        {
            NordStructurePieces$village = GreekStructurePieces.Field2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GreekStructurePieces.BathHouse.class)
        {
            NordStructurePieces$village = GreekStructurePieces.BathHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GreekStructurePieces.TallHouse.class)
        {
            NordStructurePieces$village = GreekStructurePieces.TallHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }

        return NordStructurePieces$village;
    }

    private static GreekStructurePieces.Village generateComponent(GreekStructurePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        else
        {
            ...
            while (j < 5)
            {
                ...
                for (GreekStructurePieces.PieceWeight NordStructurePieces$pieceweight : start.structureVillageWeightedPieceList)
                {
                    ...
                    if (k < 0)
                    {
                        ...
                        GreekStructurePieces.Village NordStructurePieces$village = findAndCreateComponentFactory(start, NordStructurePieces$pieceweight, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
            ...
            StructureBoundingBox structureboundingbox = GreekStructurePieces.Torch.findPieceBox(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);
            ...
            if (structureboundingbox != null)
            {
               // if(rand.nextInt(100) < 50) return new LatinStructurePieces.Banner(start, componentType, rand, structureboundingbox, EnumFacing.UP);///return new LatinStructurePieces.Torch(start, componentType, rand, structureboundingbox, facing);
            	...
            	return new GreekStructurePieces.Torch(start, componentType, rand, structureboundingbox, facing);
            }
            else
            {
                return null;
    ...
    private static StructureComponent generateAndAddComponent(GreekStructurePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        if (componentType > 50)
        {
            return null;
    ...
    private static StructureComponent generateAndAddRoadPiece(GreekStructurePieces.Start start, List<StructureComponent> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_)
    {
        ...
        {
            StructureBoundingBox structureboundingbox = GreekStructurePieces.Path.findPieceBox(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

            if (structureboundingbox != null && structureboundingbox.minY > 10)
            {
                StructureComponent structurecomponent = new GreekStructurePieces.Path(start, p_176069_7_, rand, structureboundingbox, facing);
    ...
    public static class ConsulHouse extends GreekStructurePieces.Village
        {
            public ConsulHouse()
            {
            }

            public ConsulHouse(GreekStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
            {
                super(start, type);
            ...
            public static GreekStructurePieces.ConsulHouse createPiece(GreekStructurePieces.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
            {
                StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(p_175854_3_, p_175854_4_, p_175854_5_, 0, 0, 0, GreekBuildingsArray.CONSUL_WIDTH, GreekBuildingsArray.CONSUL_HEIGHT, GreekBuildingsArray.CONSUL_LENGTH, facing);
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new GreekStructurePieces.ConsulHouse(start, p_175854_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                if (this.averageGroundLvl < 0)
                {
                    ...
                    this.boundingBox.offset(0, this.averageGroundLvl - this.boundingBox.maxY + GreekBuildingsArray.CONSUL_HEIGHT - 1, 0);
                }

                this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, GreekBuildingsArray.consul, GreekBuildingsArray.CONSUL_LENGTH, GreekBuildingsArray.CONSUL_HEIGHT, GreekBuildingsArray.CONSUL_WIDTH, front);
    ...
    public static class Field1 extends GreekStructurePieces.Village
        {
            ...
            public Field1(GreekStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static GreekStructurePieces.Field1 createPiece(GreekStructurePieces.Start start, List<StructureComponent> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null ? new GreekStructurePieces.Field1(start, p_175851_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Field2 extends GreekStructurePieces.Village
        {
            /** First crop type for this field. */
            private Block cropTypeA;
            /** Second crop type for this field. */
            ...
            public Field2(GreekStructurePieces.Start start, int p_i45569_2_, Random rand, StructureBoundingBox p_i45569_4_, EnumFacing facing)
            {
            ...
            public static GreekStructurePieces.Field2 createPiece(GreekStructurePieces.Start start, List<StructureComponent> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_)
            {
            	if(start.isBanditInfested) return null;
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null ? new GreekStructurePieces.Field2(start, p_175852_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class GuardHouse extends GreekStructurePieces.Village
        {
            public GuardHouse()
            {
            }

            public GuardHouse(GreekStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
                this.front = facing;
            ...
            public static GreekStructurePieces.GuardHouse createPiece(GreekStructurePieces.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
            {
                StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(p_175857_3_, p_175857_4_, p_175857_5_, 0, 0, 0, GreekBuildingsArray.GUARDHOUSE_WIDTH, GreekBuildingsArray.GUARDHOUSE_HEIGHT, GreekBuildingsArray.GUARDHOUSE_LENGTH, facing);
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new GreekStructurePieces.GuardHouse(start, p_175857_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                if (this.averageGroundLvl < 0)
                {
                    ...
                    this.boundingBox.offset(0, this.averageGroundLvl - this.boundingBox.maxY + GreekBuildingsArray.GUARDHOUSE_HEIGHT, 0);
                }
                this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, GreekBuildingsArray.guardhut_1, GreekBuildingsArray.GUARDHOUSE_LENGTH, GreekBuildingsArray.GUARDHOUSE_HEIGHT, GreekBuildingsArray.GUARDHOUSE_WIDTH, front);
    ...
    public static class ArcherHut extends GreekStructurePieces.Village
        {
            public ArcherHut()
            {
            }

            public ArcherHut(GreekStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
                this.front = facing;
            ...
            public static GreekStructurePieces.ArcherHut createPiece(GreekStructurePieces.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
            {
                StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(p_175850_3_, p_175850_4_, p_175850_5_, 0, 0, 0, GreekBuildingsArray.ARCHERHUT_WIDTH, GreekBuildingsArray.ARCHERHUT_HEIGHT, GreekBuildingsArray.ARCHERHUT_LENGTH, facing);
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new GreekStructurePieces.ArcherHut(start, p_175850_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                if (this.averageGroundLvl < 0)
                {
                    ...
                    this.boundingBox.offset(0, this.averageGroundLvl - this.boundingBox.maxY + GreekBuildingsArray.ARCHERHUT_HEIGHT - 1, 0);
                }

                this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, GreekBuildingsArray.archer_hut_1, GreekBuildingsArray.ARCHERHUT_LENGTH, GreekBuildingsArray.ARCHERHUT_HEIGHT, GreekBuildingsArray.ARCHERHUT_WIDTH, front);
    ...
    public static class BathHouse extends GreekStructurePieces.Village
        {
            ...
            public BathHouse(GreekStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
            {
                super(start, type);
                this.front = facing;
                this.setCoordBaseMode(facing);
            ...
            public static GreekStructurePieces.BathHouse createPiece(GreekStructurePieces.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
            {
                StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(p_175855_3_, p_175855_4_, p_175855_5_, 0, 0, 0, GreekBuildingsArray.BATHHOUSE_WIDTH, GreekBuildingsArray.BATHHOUSE_HEIGHT, GreekBuildingsArray.BATHHOUSE_LENGTH, facing);
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new GreekStructurePieces.BathHouse(start, p_175855_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                if (this.averageGroundLvl < 0)
                {
                    ...
                    this.boundingBox.offset(0, this.averageGroundLvl - this.boundingBox.maxY + GreekBuildingsArray.BATHHOUSE_HEIGHT - 1, 0);
                }

                this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, GreekBuildingsArray.bathhouse_1, GreekBuildingsArray.BATHHOUSE_LENGTH, GreekBuildingsArray.BATHHOUSE_HEIGHT, GreekBuildingsArray.BATHHOUSE_WIDTH, front);
    ...
    public static class TallHouse extends GreekStructurePieces.Village
        {
            public TallHouse()
            {
            }

            public TallHouse(GreekStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
            {
                super(start, type);
                this.front = facing;
                this.setCoordBaseMode(facing);
            ...
            public static GreekStructurePieces.TallHouse createPiece(GreekStructurePieces.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
            {
                StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(p_175849_3_, p_175849_4_, p_175849_5_, 0, 0, 0, GreekBuildingsArray.TALLHOUSE_WIDTH, GreekBuildingsArray.TALLHOUSE_HEIGHT, GreekBuildingsArray.TALLHOUSE_HEIGHT, facing);
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new GreekStructurePieces.TallHouse(start, p_175849_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
            	if (this.averageGroundLvl < 0)
                {
                    ...
                    this.boundingBox.offset(0, this.averageGroundLvl - this.boundingBox.maxY + GreekBuildingsArray.TALLHOUSE_HEIGHT - 1, -1);
                }

                this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, GreekBuildingsArray.tallhouse_0, GreekBuildingsArray.TALLHOUSE_LENGTH, GreekBuildingsArray.TALLHOUSE_HEIGHT, GreekBuildingsArray.TALLHOUSE_WIDTH, front);
    ...
    public static class Shrine extends GreekStructurePieces.Village
        {
            ...
            public Shrine(GreekStructurePieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
            {
            ...
            public static GreekStructurePieces.Shrine createPiece(GreekStructurePieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
            {
                StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(p_175858_3_, p_175858_4_, p_175858_5_, 0, 0, 0, GreekBuildingsArray.SHRINE_WIDTH, GreekBuildingsArray.SHRINE_HEIGHT, GreekBuildingsArray.SHRINE_LENGTH, facing);
                return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new GreekStructurePieces.Shrine(start, p_175858_7_, rand, structureboundingbox, facing);
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                if (this.averageGroundLvl < 0)
                {
                    ...
                    this.boundingBox.offset(0, this.averageGroundLvl - this.boundingBox.maxY + GreekBuildingsArray.SHRINE_HEIGHT - 1, 0);
                }
                
               this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, GreekBuildingsArray.shrine_0, GreekBuildingsArray.SHRINE_LENGTH, GreekBuildingsArray.SHRINE_HEIGHT, GreekBuildingsArray.SHRINE_WIDTH, front);
                this.spawnVillagers(worldIn, structureBoundingBoxIn, -1, 1, 2, 1, AttributeVocation.CLASS_MAGE, 0, false);
                return true;
            }
        }

    public static class Path extends GreekStructurePieces.Road
        {
            private int length;
            ...
            public Path(GreekStructurePieces.Start start, int p_i45562_2_, Random rand, StructureBoundingBox p_i45562_4_, EnumFacing facing)
            {
            ...
            public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
            {
                ...
                {
                    StructureComponent structurecomponent = this.getNextComponentNN((GreekStructurePieces.Start)componentIn, listIn, rand, 0, i);
                ...
                {
                    StructureComponent structurecomponent1 = this.getNextComponentPP((GreekStructurePieces.Start)componentIn, listIn, rand, 0, j);
                ...
                if (flag && rand.nextInt(3) > 0 && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            GreekStructurePieces.generateAndAddRoadPiece((GreekStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
                            break;
                        case SOUTH:
                            GreekStructurePieces.generateAndAddRoadPiece((GreekStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
                            break;
                        case WEST:
                            GreekStructurePieces.generateAndAddRoadPiece((GreekStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                            break;
                        case EAST:
                            GreekStructurePieces.generateAndAddRoadPiece((GreekStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
                ...
                if (flag && rand.nextInt(3) > 0 && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            GreekStructurePieces.generateAndAddRoadPiece((GreekStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
                            break;
                        case SOUTH:
                            GreekStructurePieces.generateAndAddRoadPiece((GreekStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
                            break;
                        case WEST:
                            GreekStructurePieces.generateAndAddRoadPiece((GreekStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                            break;
                        case EAST:
                            GreekStructurePieces.generateAndAddRoadPiece((GreekStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
            }

            public static StructureBoundingBox findPieceBox(GreekStructurePieces.Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing)
            {
    ...
    public static class PieceWeight
        {
            public Class <? extends GreekStructurePieces.Village > villagePieceClass;
            public final int villagePieceWeight;
            public int villagePiecesSpawned;
            public int villagePiecesLimit;

            public PieceWeight(Class <? extends GreekStructurePieces.Village > p_i2098_1_, int p_i2098_2_, int p_i2098_3_)
            {
    ...
    public abstract static class Road extends GreekStructurePieces.Village
        {
            public Road()
            {
            }

            protected Road(GreekStructurePieces.Start start, int type)
            {
                super(start, type);
            }
        }

    public static class Start extends GreekStructurePieces.Well
        {
            public BiomeProvider biomeProvider;
            /** World terrain type, 0 for normal, 1 for flap map */
            public int terrainType;
            public GreekStructurePieces.PieceWeight lastPlaced;
            /**
             ...
             */
            public List<GreekStructurePieces.PieceWeight> structureVillageWeightedPieceList;
            ...
            public Start(BiomeProvider biomeProviderIn, int p_i2104_2_, Random rand, int p_i2104_4_, int p_i2104_5_, List<GreekStructurePieces.PieceWeight> p_i2104_6_, int p_i2104_7_)
            {
                super((GreekStructurePieces.Start)null, 0, rand, p_i2104_4_, p_i2104_5_);
    ...
    public static class Torch extends GreekStructurePieces.Village
        {
            public Torch()
            {
            }

            public Torch(GreekStructurePieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
            {
            ...
            public static StructureBoundingBox findPieceBox(GreekStructurePieces.Start start, List<StructureComponent> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing)
            {
    ...
    public static class Banner extends GreekStructurePieces.Village
    {
        public Banner()
        {
        }

        public Banner(GreekStructurePieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
        {
            super(start, p_i45568_2_);
            this.front = facing;
            this.setCoordBaseMode(facing);
    ...
    public abstract static class Village extends StructureComponent
        {
            ...
            protected GreekStructurePieces.Start startPiece;

            public Village()
            {
            }

            protected Village(GreekStructurePieces.Start start, int type)
            {
                super(type);
             ...
             */
            @Nullable
            protected StructureComponent getNextComponentNN(GreekStructurePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74891_4_, int p_74891_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return GreekStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case SOUTH:
                            return GreekStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case WEST:
                            return GreekStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        case EAST:
                            return GreekStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
             ...
             */
            @Nullable
            protected StructureComponent getNextComponentPP(GreekStructurePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74894_4_, int p_74894_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return GreekStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case SOUTH:
                            return GreekStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case WEST:
                            return GreekStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        case EAST:
                            return GreekStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
            ...
            protected void spawnVillagers(World worldIn, StructureBoundingBox structurebb, int x, int y, int z, int count, int vocation, int rank, boolean upgrade)
            {
                if (this.villagersSpawned < count)
                {
                    for (int i = this.villagersSpawned; i < count; ++i)
                    {
                        ...
                        {
                        	EntityHumanVillager entityHumanVillager = new EntityHumanVillager(worldIn, WorldGenVillage.GREEK_ID, AttributeRace.getFromIDRace(WorldGenVillage.GREEK_ID).getRandomBandit(worldIn), EntityHumanVillager.getRandomGender(worldIn), vocation == AttributeVocation.CLASS_RULER ? true : false);                            
                        ...
                        else if(vocation == AttributeVocation.CLASS_RULER)
                        {
                        	if(this.ruler == null)
                        	{
                            	EntityHumanVillager entityRuler = new EntityHumanVillager(worldIn, WorldGenVillage.GREEK_ID, AttributeRace.getFromIDRace(WorldGenVillage.GREEK_ID).getRandomRuler(worldIn), EntityHumanVillager.getRandomGender(worldIn), true);                            
                        ...
                        //	if(worldIn.rand.nextInt(100) <= Main.wraith_turn_rate) ruler.setShifter(true, new EntityWraith(worldIn), false, 1);
                        	...
                        	/*AttributeFaction faction = new AttributeFaction(worldIn, new BlockPos(x, 70, z), AttributeRace.getFromIDRace(WorldGenVillage.GREEK_ID), NameGenerator.generateRandomName(worldIn.rand, AttributeRace.getFromIDRace(WorldGenVillage.GREEK_ID)));
                        	...
                        	//EntityHumanVillager entityHumanVillager = new EntityHumanVillager(worldIn, WorldGenVillage.GREEK_ID, AttributeRace.getFromIDRace(WorldGenVillage.GREEK_ID).getRandomRuler(worldIn), EntityHumanVillager.getRandomGender(worldIn));                            
                        ...
                        {
                        	EntityHumanVillager entityHumanVillager = new EntityHumanVillager(worldIn, WorldGenVillage.GREEK_ID, AttributeRace.getFromIDRace(WorldGenVillage.GREEK_ID).getRandomMercenary(worldIn), EntityHumanVillager.getRandomGender(worldIn), false);                            
                        ...
                        else
                        {
                        	...
                        	EntityHumanVillager entityHumanVillager = new EntityHumanVillager(worldIn, WorldGenVillage.GREEK_ID, vocation, rank, EntityHumanVillager.getRandomGender(worldIn));                            
                        	entityHumanVillager.setLocationAndAngles((double)j + 0.5D, (double)k, (double)l + 0.5D, 0.0F, 0.0F);
            ...
            protected IBlockState getBiomeSpecificBlockState(IBlockState blockstateIn)
            {
                ...
                if(Blocks.LOG == blockstateIn.getBlock()  || blockstateIn.getBlock()  == Blocks.LOG2){
					return Blocks.RED_SANDSTONE.getDefaultState().withProperty(BlockRedSandstone.TYPE, BlockRedSandstone.EnumType.CHISELED);//.withProperty(BlockLog.LOG_AXIS, event.getOriginal().getValue(BlockLog.LOG_AXIS))
				}
				
				if(Blocks.COBBLESTONE == blockstateIn.getBlock() ){
					return Blocks.RED_SANDSTONE.getDefaultState().withProperty(BlockRedSandstone.TYPE, BlockRedSandstone.EnumType.SMOOTH);//.withProperty(BlockLog.LOG_AXIS, event.getOriginal().getValue(BlockLog.LOG_AXIS))
					
				}
				
				if(Blocks.PLANKS == blockstateIn.getBlock() ){
					return Blocks.RED_SANDSTONE.getDefaultState();//return Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK);
				...
				if(Blocks.STONE_STAIRS == blockstateIn.getBlock()){
					return Blocks.RED_SANDSTONE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, blockstateIn.getValue(BlockStairs.FACING));//return Blocks.BIRCH_STAIRS.getDefaultState()
				}
				
				if(Blocks.GRASS_PATH == blockstateIn.getBlock() ){
					return Blocks.HARDENED_CLAY.getDefaultState();//.withProperty(BlockQuartz.VARIANT, BlockQuartz.EnumType.CHISELED);					
				}
				
				if(Blocks.GRAVEL == blockstateIn.getBlock() ){
					return Blocks.CLAY.getDefaultState();//.withProperty(BlockQuartz.VARIANT, BlockQuartz.EnumType.CHISELED);					
				}
				...
				if(Blocks.STONEBRICK == blockstateIn.getBlock() ){
					return Blocks.RED_SANDSTONE.getDefaultState();//.withProperty(BlockQuartz.VARIANT, BlockQuartz.EnumType.CHISELED);					
				}
    ...
    public static class Well extends GreekStructurePieces.Village
        {
    	 public Well()
         {
         }

         public Well(GreekStructurePieces.Start start, int type, Random rand, int x, int z)
         {
             super(start, type);
         ...
         public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
         {
             GreekStructurePieces.generateAndAddRoadPiece((GreekStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
             GreekStructurePieces.generateAndAddRoadPiece((GreekStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
             GreekStructurePieces.generateAndAddRoadPiece((GreekStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
             GreekStructurePieces.generateAndAddRoadPiece((GreekStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
         }
    ...
    public static class SmallHut extends GreekStructurePieces.Village
        {
            ...
            public SmallHut(GreekStructurePieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
                this.front = facing;
            ...
            public static GreekStructurePieces.SmallHut createPiece(GreekStructurePieces.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
            {
                StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(p_175853_3_, p_175853_4_, p_175853_5_, 0, 0, 0, GreekBuildingsArray.SMALLHUT_WIDTH, GreekBuildingsArray.SMALLHUT_HEIGHT, GreekBuildingsArray.SMALLHUT_LENGTH, facing);
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new GreekStructurePieces.SmallHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                if (this.averageGroundLvl < 0)
                {
                    ...
                    this.boundingBox.offset(0, this.averageGroundLvl - this.boundingBox.maxY + GreekBuildingsArray.SMALLHUT_HEIGHT, 0);
                }

                this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, GreekBuildingsArray.smallhut_1, GreekBuildingsArray.SMALLHUT_LENGTH, GreekBuildingsArray.SMALLHUT_HEIGHT, GreekBuildingsArray.SMALLHUT_WIDTH, front);
