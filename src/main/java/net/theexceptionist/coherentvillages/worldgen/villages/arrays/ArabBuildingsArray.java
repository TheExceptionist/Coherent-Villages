...
//private static final IBlockState spruceStairsCorner = Blocks.SPRUCE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.);
...
//private static final IBlockState spruceStairsCorner = Blocks.SPRUCE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.);
	public static final char[][] barracks = 
	{
			{
				' ', 'F', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 
				'*', '*', '*', '*', '*', '*', '*', '*', '*', '*', 
...
//private static final IBlockState spruceStairsCorner = Blocks.SPRUCE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.);
	public static final char[][] university = 
	{
		{
			'*', '*', 'F', '*', '*', '*', '*', '*', '*', '*', '*', '*', '*', 
			'*', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', '*', 
...
//private static final IBlockState spruceStairsCorner = Blocks.SPRUCE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.);
	public static final char[][] alchemy = 
	{
		{
			'*', '*', 'F', '*', '*', '*', '*', '*', '*', '*', '*', '*', '*', 
			'*', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', '*', 
...
//private static final IBlockState spruceStairsCorner = Blocks.SPRUCE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.);
	...
	/*public static final char[][] guardhouse = 
		{
				//Fills x first
				//z next
				{
	...
	public static final char[][] bathhouse_1 = 
		{
				//Fills x first
				//z next
			{
	...
	public static final char[][] smallhut_1 = 
		{
				//Fills x first
				//z next
				{
	...
	public static final char[][] guardhut_1 = 
		{
			{
				' ', 'E', ' ', ' ', ' ', ' ', 
				'^', '+', '*', '*', '*', '^',
	...
	public static final char[][] tallhouse_0 =
		{
			{
				' ', 'E', ' ', ' ', ' ', ' ', 
				'^', '+', '*', '*', '*', '^',
	...
	public static final char[][] shrine_0 =
		{
				{
					'^', 'E', 'E', 'E', 'E', '^',
					'L', '+', '+', '+', '+', 'R',
