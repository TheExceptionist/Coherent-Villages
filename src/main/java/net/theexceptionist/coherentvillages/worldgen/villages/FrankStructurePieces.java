...
public class FrankStructurePieces
{
    public static void registerVillagePieces()
    {
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.ArcherHut.class, "ViBH");//**
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.Field1.class, "ViDF");//**
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.Field2.class, "ViF");//**
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.Torch.class, "ViL");//**
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.GuardHouse.class, "ViGH");//**
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.Shrine.class, "ViSH");//
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.SmallHut.class, "ViSmH");//**
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.ConsulHouse.class, "ViST");//**
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.BathHouse.class, "ViS");//**
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.Start.class, "ViStart");//**
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.Path.class, "ViSR");//**
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.TallHouse.class, "ViLH");//**
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.Well.class, "ViW");//**
    }

    public static List<FrankStructurePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size)
    {
        List<FrankStructurePieces.PieceWeight> list = Lists.<FrankStructurePieces.PieceWeight>newArrayList();
        list.add(new FrankStructurePieces.PieceWeight(FrankStructurePieces.Shrine.class, 4, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new FrankStructurePieces.PieceWeight(FrankStructurePieces.ConsulHouse.class, 20, MathHelper.getInt(random, 0 + size, 1 + size)));
        list.add(new FrankStructurePieces.PieceWeight(FrankStructurePieces.ArcherHut.class, 20, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new FrankStructurePieces.PieceWeight(FrankStructurePieces.SmallHut.class, 3, MathHelper.getInt(random, 2 + size, 5 + size * 3)));
        list.add(new FrankStructurePieces.PieceWeight(FrankStructurePieces.TallHouse.class, 15, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new FrankStructurePieces.PieceWeight(FrankStructurePieces.Field1.class, 3, MathHelper.getInt(random, 1 + size, 4 + size)));
        list.add(new FrankStructurePieces.PieceWeight(FrankStructurePieces.Field2.class, 3, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new FrankStructurePieces.PieceWeight(FrankStructurePieces.BathHouse.class, 15, MathHelper.getInt(random, 0, 1 + size)));
        list.add(new FrankStructurePieces.PieceWeight(FrankStructurePieces.GuardHouse.class, 8, MathHelper.getInt(random, 0 + size, 3 + size * 2)));
        Iterator<FrankStructurePieces.PieceWeight> iterator = list.iterator();
    ...
    private static int updatePieceWeight(List<FrankStructurePieces.PieceWeight> p_75079_0_)
    {
        boolean flag = false;
        int i = 0;

        for (FrankStructurePieces.PieceWeight NordStructurePieces$pieceweight : p_75079_0_)
        {
    ...
    private static FrankStructurePieces.Village findAndCreateComponentFactory(FrankStructurePieces.Start start, FrankStructurePieces.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        Class <? extends FrankStructurePieces.Village > oclass = weight.villagePieceClass;
        FrankStructurePieces.Village NordStructurePieces$village = null;

        if (oclass == FrankStructurePieces.Shrine.class)
        {
            NordStructurePieces$village = FrankStructurePieces.Shrine.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == FrankStructurePieces.ConsulHouse.class)
        {
            NordStructurePieces$village = FrankStructurePieces.ConsulHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == FrankStructurePieces.ArcherHut.class)
        {
            NordStructurePieces$village = FrankStructurePieces.ArcherHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == FrankStructurePieces.SmallHut.class)
        {
            NordStructurePieces$village = FrankStructurePieces.SmallHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == FrankStructurePieces.GuardHouse.class)
        {
            NordStructurePieces$village = FrankStructurePieces.GuardHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == FrankStructurePieces.Field1.class)
        {
            NordStructurePieces$village = FrankStructurePieces.Field1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == FrankStructurePieces.Field2.class)
        {
            NordStructurePieces$village = FrankStructurePieces.Field2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == FrankStructurePieces.BathHouse.class)
        {
            NordStructurePieces$village = FrankStructurePieces.BathHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == FrankStructurePieces.TallHouse.class)
        {
            NordStructurePieces$village = FrankStructurePieces.TallHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }

        return NordStructurePieces$village;
    }

    private static FrankStructurePieces.Village generateComponent(FrankStructurePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        else
        {
            ...
            while (j < 5)
            {
                ...
                for (FrankStructurePieces.PieceWeight NordStructurePieces$pieceweight : start.structureVillageWeightedPieceList)
                {
                    ...
                    if (k < 0)
                    {
                        ...
                        FrankStructurePieces.Village NordStructurePieces$village = findAndCreateComponentFactory(start, NordStructurePieces$pieceweight, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
            ...
            StructureBoundingBox structureboundingbox = FrankStructurePieces.Torch.findPieceBox(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);

            if (structureboundingbox != null)
            {
                return new FrankStructurePieces.Torch(start, componentType, rand, structureboundingbox, facing);
            }
            else
            {
                return null;
    ...
    private static StructureComponent generateAndAddComponent(FrankStructurePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        if (componentType > 50)
        {
            return null;
    ...
    private static StructureComponent generateAndAddRoadPiece(FrankStructurePieces.Start start, List<StructureComponent> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_)
    {
        ...
        {
            StructureBoundingBox structureboundingbox = FrankStructurePieces.Path.findPieceBox(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

            if (structureboundingbox != null && structureboundingbox.minY > 10)
            {
                StructureComponent structurecomponent = new FrankStructurePieces.Path(start, p_176069_7_, rand, structureboundingbox, facing);
    ...
    public static class ConsulHouse extends FrankStructurePieces.Village
        {
            public ConsulHouse()
            {
            }

            public ConsulHouse(FrankStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
            {
                super(start, type);
            ...
            public static FrankStructurePieces.ConsulHouse createPiece(FrankStructurePieces.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new FrankStructurePieces.ConsulHouse(start, p_175854_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Field1 extends FrankStructurePieces.Village
        {
            ...
            public Field1(FrankStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static FrankStructurePieces.Field1 createPiece(FrankStructurePieces.Start start, List<StructureComponent> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null ? new FrankStructurePieces.Field1(start, p_175851_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Field2 extends FrankStructurePieces.Village
        {
            /** First crop type for this field. */
            private Block cropTypeA;
            /** Second crop type for this field. */
            ...
            public Field2(FrankStructurePieces.Start start, int p_i45569_2_, Random rand, StructureBoundingBox p_i45569_4_, EnumFacing facing)
            {
            ...
            public static FrankStructurePieces.Field2 createPiece(FrankStructurePieces.Start start, List<StructureComponent> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_)
            {
            	if(start.isBanditInfested) return null;
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null ? new FrankStructurePieces.Field2(start, p_175852_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class GuardHouse extends FrankStructurePieces.Village
        {
            public GuardHouse()
            {
            }

            public GuardHouse(FrankStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static FrankStructurePieces.GuardHouse createPiece(FrankStructurePieces.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new FrankStructurePieces.GuardHouse(start, p_175857_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class ArcherHut extends FrankStructurePieces.Village
        {
            public ArcherHut()
            {
            }

            public ArcherHut(FrankStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static FrankStructurePieces.ArcherHut createPiece(FrankStructurePieces.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new FrankStructurePieces.ArcherHut(start, p_175850_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class BathHouse extends FrankStructurePieces.Village
        {
            ...
            public BathHouse(FrankStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static FrankStructurePieces.BathHouse createPiece(FrankStructurePieces.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new FrankStructurePieces.BathHouse(start, p_175855_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class TallHouse extends FrankStructurePieces.Village
        {
            public TallHouse()
            {
            }

            public TallHouse(FrankStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static FrankStructurePieces.TallHouse createPiece(FrankStructurePieces.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new FrankStructurePieces.TallHouse(start, p_175849_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Shrine extends FrankStructurePieces.Village
        {
            ...
            public Shrine(FrankStructurePieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
            {
            ...
            public static FrankStructurePieces.Shrine createPiece(FrankStructurePieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
            {
                ...
                return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new FrankStructurePieces.Shrine(start, p_175858_7_, rand, structureboundingbox, facing);
            }
    ...
    public static class Path extends FrankStructurePieces.Road
        {
            private int length;
            ...
            public Path(FrankStructurePieces.Start start, int p_i45562_2_, Random rand, StructureBoundingBox p_i45562_4_, EnumFacing facing)
            {
            ...
            public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
            {
                ...
                {
                    StructureComponent structurecomponent = this.getNextComponentNN((FrankStructurePieces.Start)componentIn, listIn, rand, 0, i);
                ...
                {
                    StructureComponent structurecomponent1 = this.getNextComponentPP((FrankStructurePieces.Start)componentIn, listIn, rand, 0, j);
                ...
                if (flag && rand.nextInt(3) > 0 && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            FrankStructurePieces.generateAndAddRoadPiece((FrankStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
                            break;
                        case SOUTH:
                            FrankStructurePieces.generateAndAddRoadPiece((FrankStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
                            break;
                        case WEST:
                            FrankStructurePieces.generateAndAddRoadPiece((FrankStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                            break;
                        case EAST:
                            FrankStructurePieces.generateAndAddRoadPiece((FrankStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
                ...
                if (flag && rand.nextInt(3) > 0 && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            FrankStructurePieces.generateAndAddRoadPiece((FrankStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
                            break;
                        case SOUTH:
                            FrankStructurePieces.generateAndAddRoadPiece((FrankStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
                            break;
                        case WEST:
                            FrankStructurePieces.generateAndAddRoadPiece((FrankStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                            break;
                        case EAST:
                            FrankStructurePieces.generateAndAddRoadPiece((FrankStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
            }

            public static StructureBoundingBox findPieceBox(FrankStructurePieces.Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing)
            {
    ...
    public static class PieceWeight
        {
            public Class <? extends FrankStructurePieces.Village > villagePieceClass;
            public final int villagePieceWeight;
            public int villagePiecesSpawned;
            public int villagePiecesLimit;

            public PieceWeight(Class <? extends FrankStructurePieces.Village > p_i2098_1_, int p_i2098_2_, int p_i2098_3_)
            {
    ...
    public abstract static class Road extends FrankStructurePieces.Village
        {
            public Road()
            {
            }

            protected Road(FrankStructurePieces.Start start, int type)
            {
                super(start, type);
            }
        }

    public static class Start extends FrankStructurePieces.Well
        {
            public BiomeProvider biomeProvider;
            /** World terrain type, 0 for normal, 1 for flap map */
            public int terrainType;
            public FrankStructurePieces.PieceWeight lastPlaced;
            /**
             ...
             */
            public List<FrankStructurePieces.PieceWeight> structureVillageWeightedPieceList;
            ...
            public Start(BiomeProvider biomeProviderIn, int p_i2104_2_, Random rand, int p_i2104_4_, int p_i2104_5_, List<FrankStructurePieces.PieceWeight> p_i2104_6_, int p_i2104_7_)
            {
                super((FrankStructurePieces.Start)null, 0, rand, p_i2104_4_, p_i2104_5_);
                ...
                this.isZombieInfested = rand.nextInt(100) <= Main.frank_zombie_infest_rate;
                if(!this.isZombieInfested) 
                {
                	this.isBanditInfested = rand.nextInt(100) <= Main.frank_bandit_infest_rate;
                }
                else 
                {
    ...
    public static class Torch extends FrankStructurePieces.Village
        {
            public Torch()
            {
            }

            public Torch(FrankStructurePieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
            {
            ...
            public static StructureBoundingBox findPieceBox(FrankStructurePieces.Start start, List<StructureComponent> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing)
            {
    ...
    public abstract static class Village extends StructureComponent
        {
            ...
            protected FrankStructurePieces.Start startPiece;

            public Village()
            {
            }

            protected Village(FrankStructurePieces.Start start, int type)
            {
                super(type);
             ...
             */
            @Nullable
            protected StructureComponent getNextComponentNN(FrankStructurePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74891_4_, int p_74891_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return FrankStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case SOUTH:
                            return FrankStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case WEST:
                            return FrankStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        case EAST:
                            return FrankStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
             ...
             */
            @Nullable
            protected StructureComponent getNextComponentPP(FrankStructurePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74894_4_, int p_74894_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return FrankStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case SOUTH:
                            return FrankStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case WEST:
                            return FrankStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        case EAST:
                            return FrankStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
    ...
    public static class Well extends FrankStructurePieces.Village
        {
    	 public Well()
         {
         }

         public Well(FrankStructurePieces.Start start, int type, Random rand, int x, int z)
         {
             super(start, type);
         ...
         public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
         {
             FrankStructurePieces.generateAndAddRoadPiece((FrankStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
             FrankStructurePieces.generateAndAddRoadPiece((FrankStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
             FrankStructurePieces.generateAndAddRoadPiece((FrankStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
             FrankStructurePieces.generateAndAddRoadPiece((FrankStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
         }
    ...
    public static class SmallHut extends FrankStructurePieces.Village
        {
            ...
            public SmallHut(FrankStructurePieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static FrankStructurePieces.SmallHut createPiece(FrankStructurePieces.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new FrankStructurePieces.SmallHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
            }
