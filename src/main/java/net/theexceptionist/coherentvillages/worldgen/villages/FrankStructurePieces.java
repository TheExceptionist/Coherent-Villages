...
public class FrankStructurePieces
{
    public static void registerVillagePieces()
    {
        ...
        MapGenStructureIO.registerStructureComponent(FrankStructurePieces.Banner.class, "ViB");
    ...
    public static class Banner extends FrankStructurePieces.Village
    {
        public Banner()
        {
        }

        public Banner(FrankStructurePieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
        {
            super(start, p_i45568_2_);
            this.front = facing;
            this.setCoordBaseMode(facing);
