...
public class BritonStructurePieces
{
    public static void registerVillagePieces()
    {
        ...
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.Banner.class, "ViB");
    ...
    public static class Banner extends BritonStructurePieces.Village
    {
        public Banner()
        {
        }

        public Banner(BritonStructurePieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
        {
            super(start, p_i45568_2_);
            this.front = facing;
            this.setCoordBaseMode(facing);
