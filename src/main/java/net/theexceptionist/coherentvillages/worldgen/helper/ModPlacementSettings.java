...
public class ModPlacementSettings 
{
    ...
    {
        ModPlacementSettings placementsettings = new ModPlacementSettings();
    ...
    public ModPlacementSettings setMirror(Mirror mirrorIn)
    {
        this.mirror = mirrorIn;
        return this;
    }

    public ModPlacementSettings setRotation(Rotation rotationIn)
    {
        this.rotation = rotationIn;
        return this;
    }

    public ModPlacementSettings setIgnoreEntities(boolean ignoreEntitiesIn)
    {
        this.ignoreEntities = ignoreEntitiesIn;
        return this;
    }

    public ModPlacementSettings setReplacedBlock(Block replacedBlockIn)
    {
        this.replacedBlock = replacedBlockIn;
        return this;
    }

    public ModPlacementSettings setChunk(ChunkPos chunkPosIn)
    {
        this.chunk = chunkPosIn;
        return this;
    }

    public ModPlacementSettings setBoundingBox(StructureBoundingBox boundingBoxIn)
    {
        this.boundingBox = boundingBoxIn;
        return this;
    }

    public ModPlacementSettings setSeed(@Nullable Long seedIn)
    {
        this.setSeed = seedIn;
        return this;
    }

    public ModPlacementSettings setRandom(@Nullable Random randomIn)
    {
        this.random = randomIn;
        return this;
    }

    public ModPlacementSettings setIntegrity(float integrityIn)
    {
    ...
    public ModPlacementSettings setIgnoreStructureBlock(boolean ignoreStructureBlockIn)
    {
