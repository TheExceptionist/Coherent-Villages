...
public class ModTemplate 
{
    ...
    public Map<BlockPos, String> getDataBlocks(BlockPos pos, ModPlacementSettings placementIn)
    {
    ...
    public BlockPos calculateConnectedPos(ModPlacementSettings placementIn, BlockPos p_186262_2_, ModPlacementSettings p_186262_3_, BlockPos p_186262_4_)
    {
    ...
    public static BlockPos transformedBlockPos(ModPlacementSettings placementIn, BlockPos pos)
    {
     ...
     * bounding box.
     *  
     * @see ModPlacementSettings#setBoundingBoxFromChunk
     *  
     * @param worldIn The world to use
     * @param pos The origin position for the structure
     */
    public void addBlocksToWorldChunk(World worldIn, BlockPos pos, ModPlacementSettings placementIn)
    {
     ...
     */
    public void addBlocksToWorld(World worldIn, BlockPos pos, ModPlacementSettings placementIn)
    {
        this.addBlocksToWorld(worldIn, pos, new ModBlockRotation(pos, placementIn), placementIn, 2);
    }
     ...
     */
    public void addBlocksToWorld(World worldIn, BlockPos pos, ModPlacementSettings placementIn, int flags)
    {
        this.addBlocksToWorld(worldIn, pos, new ModBlockRotation(pos, placementIn), placementIn, flags);
    }
     ...
     * @param flags Flags to pass to {@link World#setBlockState(BlockPos, IBlockState, int)}
     */
    public void addBlocksToWorld(World worldIn, BlockPos pos, @Nullable ITemplateProcessor templateProcessor, ModPlacementSettings placementIn, int flags)
    {
        if ((!this.blocks.isEmpty() || !placementIn.getIgnoreEntities() && !this.entities.isEmpty()) && this.size.getX() >= 1 && this.size.getY() >= 1 && this.size.getZ() >= 1)
        {
            ...
            for (Template.BlockInfo template$blockinfo : this.blocks)
            {
                ...
                if (template$blockinfo1 != null)
                {
                    ...
                    worldIn.setBlockState(blockpos, block1.getDefaultState());
