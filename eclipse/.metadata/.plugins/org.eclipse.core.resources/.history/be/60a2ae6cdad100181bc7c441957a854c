...
public class RenderVillagerBanditHorseman extends RenderVillagerSoldier{
	private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/bandit_h.png");
	/*
	...
	*/
    ...
    public RenderVillagerBanditHorseman(RenderManager renderManagerIn)
    {
