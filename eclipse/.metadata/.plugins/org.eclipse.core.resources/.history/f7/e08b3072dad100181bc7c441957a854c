...
import net.theexceptionist.coherentvillages.main.Resources;
	...
	public class RenderVillagerPotionMaster extends RenderLiving<EntityVillager>
	{
...
*/
		private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/alchemist_c.png");
		
	    public RenderVillagerPotionMaster(RenderManager renderManagerIn)
	    {
