...
public class RenderVillagerMilitia extends RenderVillagerSoldier{
	private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/soldier_b.png");
	/*
	...
	*/
    ...
    public RenderVillagerMilitia(RenderManager renderManagerIn)
    {
