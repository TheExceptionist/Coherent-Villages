...
import net.theexceptionist.coherentvillages.main.Resources;
	...
	public class RenderVillagerHorseArcher extends RenderBiped<EntityVillager>
	{
...
*/
		private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/knight_h.png");
		...
		*/
	    ...
	    public RenderVillagerHorseArcher(RenderManager renderManagerIn)
	    {
