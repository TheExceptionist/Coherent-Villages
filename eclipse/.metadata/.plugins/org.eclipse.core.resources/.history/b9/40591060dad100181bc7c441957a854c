...
import net.theexceptionist.coherentvillages.main.Resources;
	...
	public class RenderVillagerApothecary extends RenderBiped<EntityVillager>
	{
...
*/
		private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/knight_a.png");
		...
		*/
	    ...
	    public RenderVillagerApothecary(RenderManager renderManagerIn)
	    {
