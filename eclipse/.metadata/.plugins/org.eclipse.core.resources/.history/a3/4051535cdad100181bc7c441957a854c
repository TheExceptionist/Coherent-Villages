...
public class EntityAIAttackKnight extends EntityAIBase
{
    World world;
    ...
    public EntityAIAttackKnight(EntityCreature creature, double speedIn, boolean useLongMemory)
    {
    ...
    protected void checkAndPerformAttack(EntityLivingBase p_190102_1_, double p_190102_2_)
    {
       ...
       // System.out.println("Swing!: "+d0+" | "+p_190102_2_);
