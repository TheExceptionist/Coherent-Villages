...
import net.theexceptionist.coherentvillages.main.Resources;
	...
	public class RenderVillagerPaladin extends RenderBiped<EntityVillager>
	{
...
*/
		private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/knight_p.png");
		...
		*/
	    ...
	    public RenderVillagerPaladin(RenderManager renderManagerIn)
	    {
