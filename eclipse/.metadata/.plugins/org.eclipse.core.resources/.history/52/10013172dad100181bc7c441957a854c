...
import net.theexceptionist.coherentvillages.main.Resources;
	...
	public class RenderVillagerUndeadHunter extends RenderLiving<EntityVillager>
	{
...
*/
		private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/alchemist_b.png");
		
	    public RenderVillagerUndeadHunter(RenderManager renderManagerIn)
	    {
