...
public class ArabStructurePieces
{
    ...
    {
        MapGenStructureIO.registerStructureComponent(ArabStructurePieces.House1.class, "ViBH");
        ...
        MapGenStructureIO.registerStructureComponent(ArabStructurePieces.Hall.class, "ViPH");
        MapGenStructureIO.registerStructureComponent(ArabStructurePieces.House4Garden.class, "ViSH");
        MapGenStructureIO.registerStructureComponent(ArabStructurePieces.WoodHut.class, "ViSmH");
        MapGenStructureIO.registerStructureComponent(ArabStructurePieces.Church.class, "ViST");
        MapGenStructureIO.registerStructureComponent(ArabStructurePieces.House2.class, "ViS");
        ...
        MapGenStructureIO.registerStructureComponent(ArabStructurePieces.House3.class, "ViTRH");
    ...
    public static List<ArabStructurePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size)
    {
        ...
        list.add(new ArabStructurePieces.PieceWeight(ArabStructurePieces.House4Garden.class, 4, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new ArabStructurePieces.PieceWeight(ArabStructurePieces.Church.class, 20, MathHelper.getInt(random, 0 + size, 1 + size)));
        list.add(new ArabStructurePieces.PieceWeight(ArabStructurePieces.House1.class, 20, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new ArabStructurePieces.PieceWeight(ArabStructurePieces.WoodHut.class, 3, MathHelper.getInt(random, 2 + size, 5 + size * 3)));
        list.add(new ArabStructurePieces.PieceWeight(ArabStructurePieces.Hall.class, 15, MathHelper.getInt(random, 0 + size, 2 + size)));
        ...
        list.add(new ArabStructurePieces.PieceWeight(ArabStructurePieces.House2.class, 15, MathHelper.getInt(random, 0, 1 + size)));
        list.add(new ArabStructurePieces.PieceWeight(ArabStructurePieces.House3.class, 8, MathHelper.getInt(random, 0 + size, 3 + size * 2)));
    ...
    private static ArabStructurePieces.Village findAndCreateComponentFactory(ArabStructurePieces.Start start, ArabStructurePieces.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        if (oclass == ArabStructurePieces.House4Garden.class)
        {
            NordStructurePieces$village = ArabStructurePieces.House4Garden.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == ArabStructurePieces.Church.class)
        {
            NordStructurePieces$village = ArabStructurePieces.Church.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == ArabStructurePieces.House1.class)
        {
            NordStructurePieces$village = ArabStructurePieces.House1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == ArabStructurePieces.WoodHut.class)
        {
            NordStructurePieces$village = ArabStructurePieces.WoodHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == ArabStructurePieces.Hall.class)
        {
            NordStructurePieces$village = ArabStructurePieces.Hall.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        ...
        else if (oclass == ArabStructurePieces.House2.class)
        {
            NordStructurePieces$village = ArabStructurePieces.House2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == ArabStructurePieces.House3.class)
        {
            NordStructurePieces$village = ArabStructurePieces.House3.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
    ...
    public static class Church extends ArabStructurePieces.Village
        {
            public Church()
            {
            }

            public Church(ArabStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
            {
                super(start, type);
            ...
            public static ArabStructurePieces.Church createPiece(ArabStructurePieces.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new ArabStructurePieces.Church(start, p_175854_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Hall extends ArabStructurePieces.Village
        {
            public Hall()
            {
            }

            public Hall(ArabStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static ArabStructurePieces.Hall createPiece(ArabStructurePieces.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new ArabStructurePieces.Hall(start, p_175857_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House1 extends ArabStructurePieces.Village
        {
            public House1()
            {
            }

            public House1(ArabStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static ArabStructurePieces.House1 createPiece(ArabStructurePieces.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new ArabStructurePieces.House1(start, p_175850_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House2 extends ArabStructurePieces.Village
        {
            ...
            public House2(ArabStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static ArabStructurePieces.House2 createPiece(ArabStructurePieces.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new ArabStructurePieces.House2(start, p_175855_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House3 extends ArabStructurePieces.Village
        {
            public House3()
            {
            }

            public House3(ArabStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static ArabStructurePieces.House3 createPiece(ArabStructurePieces.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new ArabStructurePieces.House3(start, p_175849_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House4Garden extends ArabStructurePieces.Village
        {
            ...
            public House4Garden(ArabStructurePieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
            {
            ...
            public static ArabStructurePieces.House4Garden createPiece(ArabStructurePieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
            {
                ...
                return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new ArabStructurePieces.House4Garden(start, p_175858_7_, rand, structureboundingbox, facing);
            }
            ...
            protected void spawnVillagers(World worldIn, StructureBoundingBox structurebb, int x, int y, int z, int count)
            {
                if (this.villagersSpawned < count)
                {
                    for (int i = this.villagersSpawned; i < count; ++i)
                    {
                        ...
                        {
                            EntityHumanVillager entityHumanVillager = new EntityHumanVillager(worldIn, WorldGenVillage.ARAB_ID, AttributeVocation.CLASS_VILLAGER, 0, EntityHumanVillager.getRandomGender(worldIn));
    ...
    public static class WoodHut extends ArabStructurePieces.Village
        {
            ...
            public WoodHut(ArabStructurePieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static ArabStructurePieces.WoodHut createPiece(ArabStructurePieces.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new ArabStructurePieces.WoodHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
            }
