...
public class VillageHandlerShop implements IVillageCreationHandler 
	...
	return new StructureVillagePieces.PieceWeight(VillageComponentShop.class, 4, MathHelper.getInt(random, 0 + i, 2 + i * 2)); //Play around with these numbers! 
	} 
	...
	public Village buildComponent(PieceWeight villagePiece, Start startPiece,
		...
		return VillageComponentShop.createPiece(startPiece, pieces, random, p1, p2, p3, facing, p5);
	} 
}
