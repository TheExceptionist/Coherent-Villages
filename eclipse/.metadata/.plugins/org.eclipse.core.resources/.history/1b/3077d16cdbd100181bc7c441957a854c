...
public class VillageComponentShop extends StructureVillagePieces.Village
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 9, 0, 6, iblockstate1, iblockstate1, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 1, 0, 9, 1, 6, iblockstate, iblockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 1, 1, 8, 1, 5, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
            
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 2, 0, 9, 5, 6, iblockstate1, iblockstate1, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 2, 1, 8, 4, 5, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
            
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 2, 0, 0, 5, 0, iblockstate, iblockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 9, 2, 6, 9, 5, 6, iblockstate, iblockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 2, 6, 0, 5, 6, iblockstate, iblockstate, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 9, 2, 0, 9, 5, 0, iblockstate, iblockstate, false);
            
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 5, 0, 9, 5, 6, iblockstate3, iblockstate3, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 5, 1, 8, 5, 5, iblockstate1, iblockstate1, false);
            ...
            this.setBlockState(worldIn, Blocks.GLASS.getDefaultState(), 3, 2, 0, structureBoundingBoxIn);
            
            this.placeTorch(worldIn, EnumFacing.SOUTH, 2, 3, -1, structureBoundingBoxIn);
            ...
            {
	            for(int i = 0; i < 2; i++){
	                EntityArmorStand entityarmorstand = new EntityArmorStand(worldIn, this.getXWithOffset(3 + i, 5), this.getYWithOffset(1), this.getZWithOffset(3 + i, 5));
	    //            float f = (float)MathHelper.floor((MathHelper.wrapDegrees(player.rotationYaw - 180.0F) + 22.5F) / 45.0F) * 45.0F;
	                entityarmorstand.setLocationAndAngles(this.getXWithOffset(3 + i, 5), this.getYWithOffset(1), this.getZWithOffset(3 + i, 5), 0.0F, 0.0F);
	//                this.applyRandomRotations(entityarmorstand, worldIn.rand);
	  //              ItemMonsterPlacer.applyItemEntityDataToEntity(worldIn, player, itemstack, entityarmorstand);
            ...
            {
            	this.setBlockState(worldIn, iblockstate1, 0, 5, -1, structureBoundingBoxIn);
            	this.setBlockState(worldIn, Blocks.WOOL.getDefaultState(), 1, 5, -1, structureBoundingBoxIn);
            	this.setBlockState(worldIn, Blocks.WOOL.getDefaultState(), 2, 5, -1, structureBoundingBoxIn);
            	this.setBlockState(worldIn, Blocks.WOOL.getDefaultState(), 3, 5, -1, structureBoundingBoxIn);
            	this.setBlockState(worldIn, Blocks.WOOL.getDefaultState(), 4, 5, -1, structureBoundingBoxIn);
            	this.setBlockState(worldIn, iblockstate1, 5, 5, -1, structureBoundingBoxIn);
            ...
            */
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 1, 3, 2, 2, 3, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
