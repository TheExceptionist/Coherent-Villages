...
public class GermanStructurePieces
{
    ...
    {
        MapGenStructureIO.registerStructureComponent(GermanStructurePieces.House1.class, "ViBH");
        ...
        MapGenStructureIO.registerStructureComponent(GermanStructurePieces.Hall.class, "ViPH");
        MapGenStructureIO.registerStructureComponent(GermanStructurePieces.House4Garden.class, "ViSH");
        MapGenStructureIO.registerStructureComponent(GermanStructurePieces.WoodHut.class, "ViSmH");
        MapGenStructureIO.registerStructureComponent(GermanStructurePieces.Church.class, "ViST");
        MapGenStructureIO.registerStructureComponent(GermanStructurePieces.House2.class, "ViS");
        ...
        MapGenStructureIO.registerStructureComponent(GermanStructurePieces.House3.class, "ViTRH");
    ...
    public static List<GermanStructurePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size)
    {
        ...
        list.add(new GermanStructurePieces.PieceWeight(GermanStructurePieces.House4Garden.class, 4, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new GermanStructurePieces.PieceWeight(GermanStructurePieces.Church.class, 20, MathHelper.getInt(random, 0 + size, 1 + size)));
        list.add(new GermanStructurePieces.PieceWeight(GermanStructurePieces.House1.class, 20, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new GermanStructurePieces.PieceWeight(GermanStructurePieces.WoodHut.class, 3, MathHelper.getInt(random, 2 + size, 5 + size * 3)));
        list.add(new GermanStructurePieces.PieceWeight(GermanStructurePieces.Hall.class, 15, MathHelper.getInt(random, 0 + size, 2 + size)));
        ...
        list.add(new GermanStructurePieces.PieceWeight(GermanStructurePieces.House2.class, 15, MathHelper.getInt(random, 0, 1 + size)));
        list.add(new GermanStructurePieces.PieceWeight(GermanStructurePieces.House3.class, 8, MathHelper.getInt(random, 0 + size, 3 + size * 2)));
    ...
    private static GermanStructurePieces.Village findAndCreateComponentFactory(GermanStructurePieces.Start start, GermanStructurePieces.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        if (oclass == GermanStructurePieces.House4Garden.class)
        {
            NordStructurePieces$village = GermanStructurePieces.House4Garden.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GermanStructurePieces.Church.class)
        {
            NordStructurePieces$village = GermanStructurePieces.Church.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GermanStructurePieces.House1.class)
        {
            NordStructurePieces$village = GermanStructurePieces.House1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GermanStructurePieces.WoodHut.class)
        {
            NordStructurePieces$village = GermanStructurePieces.WoodHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GermanStructurePieces.Hall.class)
        {
            NordStructurePieces$village = GermanStructurePieces.Hall.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        ...
        else if (oclass == GermanStructurePieces.House2.class)
        {
            NordStructurePieces$village = GermanStructurePieces.House2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GermanStructurePieces.House3.class)
        {
            NordStructurePieces$village = GermanStructurePieces.House3.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
    ...
    public static class Church extends GermanStructurePieces.Village
        {
            public Church()
            {
            }

            public Church(GermanStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
            {
                super(start, type);
            ...
            public static GermanStructurePieces.Church createPiece(GermanStructurePieces.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new GermanStructurePieces.Church(start, p_175854_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Hall extends GermanStructurePieces.Village
        {
            public Hall()
            {
            }

            public Hall(GermanStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static GermanStructurePieces.Hall createPiece(GermanStructurePieces.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new GermanStructurePieces.Hall(start, p_175857_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House1 extends GermanStructurePieces.Village
        {
            public House1()
            {
            }

            public House1(GermanStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static GermanStructurePieces.House1 createPiece(GermanStructurePieces.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new GermanStructurePieces.House1(start, p_175850_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House2 extends GermanStructurePieces.Village
        {
            ...
            public House2(GermanStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static GermanStructurePieces.House2 createPiece(GermanStructurePieces.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new GermanStructurePieces.House2(start, p_175855_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House3 extends GermanStructurePieces.Village
        {
            public House3()
            {
            }

            public House3(GermanStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static GermanStructurePieces.House3 createPiece(GermanStructurePieces.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new GermanStructurePieces.House3(start, p_175849_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House4Garden extends GermanStructurePieces.Village
        {
            ...
            public House4Garden(GermanStructurePieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
            {
            ...
            public static GermanStructurePieces.House4Garden createPiece(GermanStructurePieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
            {
                ...
                return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new GermanStructurePieces.House4Garden(start, p_175858_7_, rand, structureboundingbox, facing);
            }
            ...
            protected void spawnVillagers(World worldIn, StructureBoundingBox structurebb, int x, int y, int z, int count)
            {
                if (this.villagersSpawned < count)
                {
                    for (int i = this.villagersSpawned; i < count; ++i)
                    {
                        ...
                        {
                        	EntityHumanVillager entityHumanVillager = new EntityHumanVillager(worldIn, WorldGenVillage.GERMAN_ID, AttributeVocation.CLASS_VILLAGER, 0, EntityHumanVillager.getRandomGender(worldIn));                           
    ...
    public static class WoodHut extends GermanStructurePieces.Village
        {
            ...
            public WoodHut(GermanStructurePieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static GermanStructurePieces.WoodHut createPiece(GermanStructurePieces.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new GermanStructurePieces.WoodHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
            }
