...
import net.theexceptionist.coherentvillages.main.Resources;
	...
	public class RenderVillagerCavalier extends RenderBiped<EntityVillager>
	{
...
*/
		private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/soldier_m.png");
		...
		*/
	    ...
	    public RenderVillagerCavalier(RenderManager renderManagerIn)
	    {
