...
public class VillageComponentCaneFarm extends StructureVillagePieces.Village
{
    ...
    public VillageComponentCaneFarm()
    {
    }

    public VillageComponentCaneFarm(StructureVillagePieces.Start start, int p_i45569_2_, Random rand, StructureBoundingBox p_i45569_4_, EnumFacing facing)
    {
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
    {
        ...
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 0, 1, 1, 0, 7, Blocks.SAND.getDefaultState(), Blocks.SAND.getDefaultState(), false);
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, 0, 1, 3, 0, 7, Blocks.SAND.getDefaultState(), Blocks.SAND.getDefaultState(), false);
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 0, 1, 5, 0, 7, Blocks.SAND.getDefaultState(), Blocks.SAND.getDefaultState(), false);
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 0, 1, 2, 0, 7, Blocks.WATER.getDefaultState(), Blocks.WATER.getDefaultState(), false);
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 0, 1, 4, 0, 7, Blocks.WATER.getDefaultState(), Blocks.WATER.getDefaultState(), false);
        ...
        for (int i = 1; i <= 7; ++i)
        {
            ...
            int i2 = o / 3;
            //this.setBlockState(worldIn, this.cropTypeB.getStateFromMeta(MathHelper.getInt(randomIn, i1, l)), 4, 1, i, structureBoundingBoxIn);
            this.setBlockState(worldIn, this.cropTypeB.getStateFromMeta(MathHelper.getInt(randomIn, i2, o)), 3, 1, i, structureBoundingBoxIn);
