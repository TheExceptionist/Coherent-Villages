...
public class RenderVillagerDarkKnight extends RenderVillagerSoldier{
	private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/bandit_d.png");
	/*
	...
	*/
    ...
    public RenderVillagerDarkKnight(RenderManager renderManagerIn)
    {
