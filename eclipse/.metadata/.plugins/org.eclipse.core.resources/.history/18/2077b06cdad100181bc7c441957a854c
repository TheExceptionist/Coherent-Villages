...
public class RenderVillagerBanditMage extends RenderVillagerSoldier{
	private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/bandit_m.png");
	/*
	...
	*/
    ...
    public RenderVillagerBanditMage(RenderManager renderManagerIn)
    {
