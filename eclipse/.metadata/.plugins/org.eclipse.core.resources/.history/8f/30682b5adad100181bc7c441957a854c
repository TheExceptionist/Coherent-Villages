...
import net.theexceptionist.coherentvillages.main.Resources;
	...
	public class RenderVillagerGrandMage  extends  RenderLiving<EntityVillager>
	{
		private static final ResourceLocation VILLAGER_SOLDIER_TEXTURE = new ResourceLocation(Resources.MODID,"textures/entity/villager/mage_a.png");

		public RenderVillagerGrandMage(RenderManager renderManagerIn)
	    {
