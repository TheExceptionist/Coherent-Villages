...
public class EntityVillagerEvilMage extends EntityVillagerMage implements IRangedAttackMob{
      ...
      //  this.tasks.addTask(3, new EntityAIMoveThroughVillage(this, 0.6D, true));
       ...
       // this.targetTasks.addTask(1, new EntityAIGuardPost(this, true));
        this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityLiving.class, 2, false, true, new Predicate<EntityLiving>()
        {
            ...
            {
                return p_apply_1_ != null && ((p_apply_1_ instanceof EntityVillager) || (p_apply_1_ instanceof EntityCreeper));
            }
        }));
