...
public class EntityVillagerCreeperHunter extends EntityVillager{
	...
	public EntityVillagerCreeperHunter(World worldIn) {
		super(worldIn);
	}
	
	public EntityVillagerCreeperHunter(World world, int i) {
		super(world);
		this.type = i;
//		this.
	}
