...
public class BritonStructurePieces
{
    public static void registerVillagePieces()
    {
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.ArcherHut.class, "ViBH");//**
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.Field1.class, "ViDF");//**
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.Field2.class, "ViF");//**
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.Torch.class, "ViL");//**
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.GuardHouse.class, "ViGH");//**
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.Shrine.class, "ViSH");//
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.SmallHut.class, "ViSmH");//**
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.ConsulHouse.class, "ViST");//**
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.BathHouse.class, "ViS");//**
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.Start.class, "ViStart");//**
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.Path.class, "ViSR");//**
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.TallHouse.class, "ViLH");//**
        MapGenStructureIO.registerStructureComponent(BritonStructurePieces.Well.class, "ViW");//**
    }

    public static List<BritonStructurePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size)
    {
        List<BritonStructurePieces.PieceWeight> list = Lists.<BritonStructurePieces.PieceWeight>newArrayList();
        list.add(new BritonStructurePieces.PieceWeight(BritonStructurePieces.Shrine.class, 4, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new BritonStructurePieces.PieceWeight(BritonStructurePieces.ConsulHouse.class, 20, MathHelper.getInt(random, 0 + size, 1 + size)));
        list.add(new BritonStructurePieces.PieceWeight(BritonStructurePieces.ArcherHut.class, 20, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new BritonStructurePieces.PieceWeight(BritonStructurePieces.SmallHut.class, 3, MathHelper.getInt(random, 2 + size, 5 + size * 3)));
        list.add(new BritonStructurePieces.PieceWeight(BritonStructurePieces.TallHouse.class, 15, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new BritonStructurePieces.PieceWeight(BritonStructurePieces.Field1.class, 3, MathHelper.getInt(random, 1 + size, 4 + size)));
        list.add(new BritonStructurePieces.PieceWeight(BritonStructurePieces.Field2.class, 3, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new BritonStructurePieces.PieceWeight(BritonStructurePieces.BathHouse.class, 15, MathHelper.getInt(random, 0, 1 + size)));
        list.add(new BritonStructurePieces.PieceWeight(BritonStructurePieces.GuardHouse.class, 8, MathHelper.getInt(random, 0 + size, 3 + size * 2)));
        Iterator<BritonStructurePieces.PieceWeight> iterator = list.iterator();
    ...
    private static int updatePieceWeight(List<BritonStructurePieces.PieceWeight> p_75079_0_)
    {
        boolean flag = false;
        int i = 0;

        for (BritonStructurePieces.PieceWeight NordStructurePieces$pieceweight : p_75079_0_)
        {
    ...
    private static BritonStructurePieces.Village findAndCreateComponentFactory(BritonStructurePieces.Start start, BritonStructurePieces.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        Class <? extends BritonStructurePieces.Village > oclass = weight.villagePieceClass;
        BritonStructurePieces.Village NordStructurePieces$village = null;

        if (oclass == BritonStructurePieces.Shrine.class)
        {
            NordStructurePieces$village = BritonStructurePieces.Shrine.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == BritonStructurePieces.ConsulHouse.class)
        {
            NordStructurePieces$village = BritonStructurePieces.ConsulHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == BritonStructurePieces.ArcherHut.class)
        {
            NordStructurePieces$village = BritonStructurePieces.ArcherHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == BritonStructurePieces.SmallHut.class)
        {
            NordStructurePieces$village = BritonStructurePieces.SmallHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == BritonStructurePieces.GuardHouse.class)
        {
            NordStructurePieces$village = BritonStructurePieces.GuardHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == BritonStructurePieces.Field1.class)
        {
            NordStructurePieces$village = BritonStructurePieces.Field1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == BritonStructurePieces.Field2.class)
        {
            NordStructurePieces$village = BritonStructurePieces.Field2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == BritonStructurePieces.BathHouse.class)
        {
            NordStructurePieces$village = BritonStructurePieces.BathHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == BritonStructurePieces.TallHouse.class)
        {
            NordStructurePieces$village = BritonStructurePieces.TallHouse.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }

        return NordStructurePieces$village;
    }

    private static BritonStructurePieces.Village generateComponent(BritonStructurePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        else
        {
            ...
            while (j < 5)
            {
                ...
                for (BritonStructurePieces.PieceWeight NordStructurePieces$pieceweight : start.structureVillageWeightedPieceList)
                {
                    ...
                    if (k < 0)
                    {
                        ...
                        BritonStructurePieces.Village NordStructurePieces$village = findAndCreateComponentFactory(start, NordStructurePieces$pieceweight, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
            ...
            StructureBoundingBox structureboundingbox = BritonStructurePieces.Torch.findPieceBox(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);

            if (structureboundingbox != null)
            {
                return new BritonStructurePieces.Torch(start, componentType, rand, structureboundingbox, facing);
            }
            else
            {
                return null;
    ...
    private static StructureComponent generateAndAddComponent(BritonStructurePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        if (componentType > 50)
        {
            return null;
    ...
    private static StructureComponent generateAndAddRoadPiece(BritonStructurePieces.Start start, List<StructureComponent> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_)
    {
        ...
        {
            StructureBoundingBox structureboundingbox = BritonStructurePieces.Path.findPieceBox(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

            if (structureboundingbox != null && structureboundingbox.minY > 10)
            {
                StructureComponent structurecomponent = new BritonStructurePieces.Path(start, p_176069_7_, rand, structureboundingbox, facing);
    ...
    public static class ConsulHouse extends BritonStructurePieces.Village
        {
            public ConsulHouse()
            {
            }

            public ConsulHouse(BritonStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
            {
                super(start, type);
            ...
            public static BritonStructurePieces.ConsulHouse createPiece(BritonStructurePieces.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new BritonStructurePieces.ConsulHouse(start, p_175854_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, LatinBuildingsArray.consul, LatinBuildingsArray.CONSUL_LENGTH, LatinBuildingsArray.CONSUL_HEIGHT, LatinBuildingsArray.CONSUL_WIDTH);
    ...
    public static class Field1 extends BritonStructurePieces.Village
        {
            ...
            public Field1(BritonStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static BritonStructurePieces.Field1 createPiece(BritonStructurePieces.Start start, List<StructureComponent> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null ? new BritonStructurePieces.Field1(start, p_175851_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Field2 extends BritonStructurePieces.Village
        {
            /** First crop type for this field. */
            private Block cropTypeA;
            /** Second crop type for this field. */
            ...
            public Field2(BritonStructurePieces.Start start, int p_i45569_2_, Random rand, StructureBoundingBox p_i45569_4_, EnumFacing facing)
            {
            ...
            public static BritonStructurePieces.Field2 createPiece(BritonStructurePieces.Start start, List<StructureComponent> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_)
            {
            	if(start.isBanditInfested) return null;
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null ? new BritonStructurePieces.Field2(start, p_175852_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class GuardHouse extends BritonStructurePieces.Village
        {
            public GuardHouse()
            {
            }

            public GuardHouse(BritonStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static BritonStructurePieces.GuardHouse createPiece(BritonStructurePieces.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new BritonStructurePieces.GuardHouse(start, p_175857_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, LatinBuildingsArray.guardhut_1, LatinBuildingsArray.GUARDHOUSE_LENGTH, LatinBuildingsArray.GUARDHOUSE_HEIGHT, LatinBuildingsArray.GUARDHOUSE_WIDTH);
    ...
    public static class ArcherHut extends BritonStructurePieces.Village
        {
            public ArcherHut()
            {
            }

            public ArcherHut(BritonStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static BritonStructurePieces.ArcherHut createPiece(BritonStructurePieces.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new BritonStructurePieces.ArcherHut(start, p_175850_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, LatinBuildingsArray.archer_hut_1, LatinBuildingsArray.ARCHERHUT_LENGTH, LatinBuildingsArray.ARCHERHUT_HEIGHT, LatinBuildingsArray.ARCHERHUT_WIDTH);
    ...
    public static class BathHouse extends BritonStructurePieces.Village
        {
            ...
            public BathHouse(BritonStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static BritonStructurePieces.BathHouse createPiece(BritonStructurePieces.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new BritonStructurePieces.BathHouse(start, p_175855_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class TallHouse extends BritonStructurePieces.Village
        {
            public TallHouse()
            {
            }

            public TallHouse(BritonStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static BritonStructurePieces.TallHouse createPiece(BritonStructurePieces.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new BritonStructurePieces.TallHouse(start, p_175849_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, LatinBuildingsArray.tallhouse_0, LatinBuildingsArray.TALLHOUSE_LENGTH, LatinBuildingsArray.TALLHOUSE_HEIGHT, LatinBuildingsArray.TALLHOUSE_WIDTH);
    ...
    public static class Shrine extends BritonStructurePieces.Village
        {
            ...
            public Shrine(BritonStructurePieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
            {
            ...
            public static BritonStructurePieces.Shrine createPiece(BritonStructurePieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
            {
                ...
                return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new BritonStructurePieces.Shrine(start, p_175858_7_, rand, structureboundingbox, facing);
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
               ...
               this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, LatinBuildingsArray.shrine_0, LatinBuildingsArray.SHRINE_LENGTH, LatinBuildingsArray.SHRINE_HEIGHT, LatinBuildingsArray.SHRINE_WIDTH);
    ...
    public static class Path extends BritonStructurePieces.Road
        {
            private int length;
            ...
            public Path(BritonStructurePieces.Start start, int p_i45562_2_, Random rand, StructureBoundingBox p_i45562_4_, EnumFacing facing)
            {
            ...
            public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
            {
                ...
                {
                    StructureComponent structurecomponent = this.getNextComponentNN((BritonStructurePieces.Start)componentIn, listIn, rand, 0, i);
                ...
                {
                    StructureComponent structurecomponent1 = this.getNextComponentPP((BritonStructurePieces.Start)componentIn, listIn, rand, 0, j);
                ...
                if (flag && rand.nextInt(3) > 0 && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            BritonStructurePieces.generateAndAddRoadPiece((BritonStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
                            break;
                        case SOUTH:
                            BritonStructurePieces.generateAndAddRoadPiece((BritonStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
                            break;
                        case WEST:
                            BritonStructurePieces.generateAndAddRoadPiece((BritonStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                            break;
                        case EAST:
                            BritonStructurePieces.generateAndAddRoadPiece((BritonStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
                ...
                if (flag && rand.nextInt(3) > 0 && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            BritonStructurePieces.generateAndAddRoadPiece((BritonStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
                            break;
                        case SOUTH:
                            BritonStructurePieces.generateAndAddRoadPiece((BritonStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
                            break;
                        case WEST:
                            BritonStructurePieces.generateAndAddRoadPiece((BritonStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                            break;
                        case EAST:
                            BritonStructurePieces.generateAndAddRoadPiece((BritonStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
            }

            public static StructureBoundingBox findPieceBox(BritonStructurePieces.Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing)
            {
    ...
    public static class PieceWeight
        {
            public Class <? extends BritonStructurePieces.Village > villagePieceClass;
            public final int villagePieceWeight;
            public int villagePiecesSpawned;
            public int villagePiecesLimit;

            public PieceWeight(Class <? extends BritonStructurePieces.Village > p_i2098_1_, int p_i2098_2_, int p_i2098_3_)
            {
    ...
    public abstract static class Road extends BritonStructurePieces.Village
        {
            public Road()
            {
            }

            protected Road(BritonStructurePieces.Start start, int type)
            {
                super(start, type);
            }
        }

    public static class Start extends BritonStructurePieces.Well
        {
            public BiomeProvider biomeProvider;
            /** World terrain type, 0 for normal, 1 for flap map */
            public int terrainType;
            public BritonStructurePieces.PieceWeight lastPlaced;
            /**
             ...
             */
            public List<BritonStructurePieces.PieceWeight> structureVillageWeightedPieceList;
            ...
            public Start(BiomeProvider biomeProviderIn, int p_i2104_2_, Random rand, int p_i2104_4_, int p_i2104_5_, List<BritonStructurePieces.PieceWeight> p_i2104_6_, int p_i2104_7_)
            {
                super((BritonStructurePieces.Start)null, 0, rand, p_i2104_4_, p_i2104_5_);
                ...
                this.isZombieInfested = rand.nextInt(100) <= Main.briton_zombie_infest_rate;
                if(!this.isZombieInfested) 
                {
                	this.isBanditInfested = rand.nextInt(100) <= Main.briton_bandit_infest_rate;
                }
                else 
                {
    ...
    public static class Torch extends BritonStructurePieces.Village
        {
            public Torch()
            {
            }

            public Torch(BritonStructurePieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
            {
            ...
            public static StructureBoundingBox findPieceBox(BritonStructurePieces.Start start, List<StructureComponent> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing)
            {
    ...
    public abstract static class Village extends StructureComponent
        {
            ...
            protected BritonStructurePieces.Start startPiece;

            public Village()
            {
            }

            protected Village(BritonStructurePieces.Start start, int type)
            {
                super(type);
             ...
             */
            @Nullable
            protected StructureComponent getNextComponentNN(BritonStructurePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74891_4_, int p_74891_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return BritonStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case SOUTH:
                            return BritonStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case WEST:
                            return BritonStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        case EAST:
                            return BritonStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
             ...
             */
            @Nullable
            protected StructureComponent getNextComponentPP(BritonStructurePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74894_4_, int p_74894_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return BritonStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case SOUTH:
                            return BritonStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case WEST:
                            return BritonStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        case EAST:
                            return BritonStructurePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
            ...
            protected void spawnVillagers(World worldIn, StructureBoundingBox structurebb, int x, int y, int z, int count, int vocation, int rank, boolean upgrade)
            {
                if (this.villagersSpawned < count)
                {
                    for (int i = this.villagersSpawned; i < count; ++i)
                    {
                        ...
                        {
                        	EntityHumanVillager entityHumanVillager = new EntityHumanVillager(worldIn, WorldGenVillage.LATIN_ID, AttributeRace.getFromIDRace(WorldGenVillage.LATIN_ID).getRandomBandit(worldIn), EntityHumanVillager.getRandomGender(worldIn), false);                            
                        ...
                        //	if(worldIn.rand.nextInt(100) <= Main.villager_bjorn_rate) entityHumanVillager.setShifter(true, new EntityBjornserker(worldIn));
                            //entityHumanVillager.setProfession(this.chooseForgeProfession(i, entityHumanVillager.getProfessionForge()));
                           // entityHumanVillager.finalizeMobSpawn(worldIn.getDifficultyForLocation(new BlockPos(entityHumanVillager)), (IEntityLivingData)null, false);
                            worldIn.spawnEntity(entityHumanVillager);
            ...
            protected void placeStructureBase(World worldIn, StructureBoundingBox structureBoundingBoxIn, Random randomIn, char[][] plan, int length, int height, int width) {
                ...
                for (int i = 0; i <= length - 1; ++i)
                {
                    for (int j = 0; j <= width - 1; ++j)
                    {
                        ...
                        this.replaceAirAndLiquidDownwards(worldIn, iblockstate10, j, -1, i, structureBoundingBoxIn);
    ...
    public static class Well extends BritonStructurePieces.Village
        {
    	 public Well()
         {
         }

         public Well(BritonStructurePieces.Start start, int type, Random rand, int x, int z)
         {
             super(start, type);
         ...
         public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
         {
             BritonStructurePieces.generateAndAddRoadPiece((BritonStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
             BritonStructurePieces.generateAndAddRoadPiece((BritonStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
             BritonStructurePieces.generateAndAddRoadPiece((BritonStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
             BritonStructurePieces.generateAndAddRoadPiece((BritonStructurePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
         }
    ...
    public static class SmallHut extends BritonStructurePieces.Village
        {
            ...
            public SmallHut(BritonStructurePieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static BritonStructurePieces.SmallHut createPiece(BritonStructurePieces.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new BritonStructurePieces.SmallHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                this.placeStructureBase(worldIn, structureBoundingBoxIn, randomIn, LatinBuildingsArray.smallhut_1, LatinBuildingsArray.SMALLHUT_LENGTH, LatinBuildingsArray.SMALLHUT_HEIGHT, LatinBuildingsArray.SMALLHUT_WIDTH);
