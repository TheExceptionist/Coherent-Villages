...
public class SlavStructurePieces
{
    ...
    {
        MapGenStructureIO.registerStructureComponent(SlavStructurePieces.House1.class, "ViBH");
        ...
        MapGenStructureIO.registerStructureComponent(SlavStructurePieces.Hall.class, "ViPH");
        MapGenStructureIO.registerStructureComponent(SlavStructurePieces.House4Garden.class, "ViSH");
        MapGenStructureIO.registerStructureComponent(SlavStructurePieces.WoodHut.class, "ViSmH");
        MapGenStructureIO.registerStructureComponent(SlavStructurePieces.Church.class, "ViST");
        MapGenStructureIO.registerStructureComponent(SlavStructurePieces.House2.class, "ViS");
        ...
        MapGenStructureIO.registerStructureComponent(SlavStructurePieces.House3.class, "ViTRH");
    ...
    public static List<SlavStructurePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size)
    {
        ...
        list.add(new SlavStructurePieces.PieceWeight(SlavStructurePieces.House4Garden.class, 4, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new SlavStructurePieces.PieceWeight(SlavStructurePieces.Church.class, 20, MathHelper.getInt(random, 0 + size, 1 + size)));
        list.add(new SlavStructurePieces.PieceWeight(SlavStructurePieces.House1.class, 20, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new SlavStructurePieces.PieceWeight(SlavStructurePieces.WoodHut.class, 3, MathHelper.getInt(random, 2 + size, 5 + size * 3)));
        list.add(new SlavStructurePieces.PieceWeight(SlavStructurePieces.Hall.class, 15, MathHelper.getInt(random, 0 + size, 2 + size)));
        ...
        list.add(new SlavStructurePieces.PieceWeight(SlavStructurePieces.House2.class, 15, MathHelper.getInt(random, 0, 1 + size)));
        list.add(new SlavStructurePieces.PieceWeight(SlavStructurePieces.House3.class, 8, MathHelper.getInt(random, 0 + size, 3 + size * 2)));
    ...
    private static SlavStructurePieces.Village findAndCreateComponentFactory(SlavStructurePieces.Start start, SlavStructurePieces.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        if (oclass == SlavStructurePieces.House4Garden.class)
        {
            NordStructurePieces$village = SlavStructurePieces.House4Garden.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == SlavStructurePieces.Church.class)
        {
            NordStructurePieces$village = SlavStructurePieces.Church.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == SlavStructurePieces.House1.class)
        {
            NordStructurePieces$village = SlavStructurePieces.House1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == SlavStructurePieces.WoodHut.class)
        {
            NordStructurePieces$village = SlavStructurePieces.WoodHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == SlavStructurePieces.Hall.class)
        {
            NordStructurePieces$village = SlavStructurePieces.Hall.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        ...
        else if (oclass == SlavStructurePieces.House2.class)
        {
            NordStructurePieces$village = SlavStructurePieces.House2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == SlavStructurePieces.House3.class)
        {
            NordStructurePieces$village = SlavStructurePieces.House3.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
    ...
    public static class Church extends SlavStructurePieces.Village
        {
            public Church()
            {
            }

            public Church(SlavStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
            {
                super(start, type);
            ...
            public static SlavStructurePieces.Church createPiece(SlavStructurePieces.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new SlavStructurePieces.Church(start, p_175854_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Hall extends SlavStructurePieces.Village
        {
            public Hall()
            {
            }

            public Hall(SlavStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static SlavStructurePieces.Hall createPiece(SlavStructurePieces.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new SlavStructurePieces.Hall(start, p_175857_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House1 extends SlavStructurePieces.Village
        {
            public House1()
            {
            }

            public House1(SlavStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static SlavStructurePieces.House1 createPiece(SlavStructurePieces.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new SlavStructurePieces.House1(start, p_175850_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House2 extends SlavStructurePieces.Village
        {
            ...
            public House2(SlavStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static SlavStructurePieces.House2 createPiece(SlavStructurePieces.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new SlavStructurePieces.House2(start, p_175855_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House3 extends SlavStructurePieces.Village
        {
            public House3()
            {
            }

            public House3(SlavStructurePieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static SlavStructurePieces.House3 createPiece(SlavStructurePieces.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new SlavStructurePieces.House3(start, p_175849_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House4Garden extends SlavStructurePieces.Village
        {
            ...
            public House4Garden(SlavStructurePieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
            {
            ...
            public static SlavStructurePieces.House4Garden createPiece(SlavStructurePieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
            {
                ...
                return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new SlavStructurePieces.House4Garden(start, p_175858_7_, rand, structureboundingbox, facing);
            }
            ...
            protected void spawnVillagers(World worldIn, StructureBoundingBox structurebb, int x, int y, int z, int count)
            {
                if (this.villagersSpawned < count)
                {
                    for (int i = this.villagersSpawned; i < count; ++i)
                    {
                        ...
                        {
                        	EntityHumanVillager entityHumanVillager = new EntityHumanVillager(worldIn, WorldGenVillage.SLAV_ID, AttributeVocation.CLASS_VILLAGER, 0, EntityHumanVillager.getRandomGender(worldIn));                           
    ...
    public static class WoodHut extends SlavStructurePieces.Village
        {
            ...
            public WoodHut(SlavStructurePieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static SlavStructurePieces.WoodHut createPiece(SlavStructurePieces.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new SlavStructurePieces.WoodHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
            }
